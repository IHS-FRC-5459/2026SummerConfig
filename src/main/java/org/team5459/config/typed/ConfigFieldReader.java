...
final class ConfigFieldReader {

  private final Map<String, ConfigNode> fields;
  private final String typeName;

  ConfigFieldReader(Map<String, ConfigNode> fields, String typeName) {
    this.fields = fields;
  ...
  Rotation2d readRotation2d(String name, Rotation2d defaultValue) {
    ConfigNode node = fields.get(name);
  ...
  Rotation3d readRotation3d(String name, Rotation3d defaultValue) {
    ConfigNode node = fields.get(name);
  ...
  Translation2d readTranslation2d(String name, Translation2d defaultValue) {
    ConfigNode node = fields.get(name);
  ...
  Translation3d readTranslation3d(String name, Translation3d defaultValue) {
    ConfigNode node = fields.get(name);
  ...
  TrapezoidProfile.Constraints readTrapezoidConstraints(
  ...
  SwerveDriveKinematicsNode readSwerveKinematics(String name) {
    ConfigNode node = fields.get(name);
  ...
  MecanumDriveKinematicsNode readMecanumKinematics(String name) {
    ConfigNode node = fields.get(name);
  ...
  DifferentialDriveKinematicsNode readDifferentialKinematics(String name) {
    ConfigNode node = fields.get(name);
  ...
  Angle readAngle(String name, Angle defaultValue) {
    ConfigNode node = fields.get(name);
  ...
  Distance readDistance(String name, Distance defaultValue) {
    ConfigNode node = fields.get(name);
