...
final class ConfigWarnings {
  ...
  static void warnMissingField(String typeName, String fieldName, Object defaultValue) {
    System.err.println(
        "[Config] "
            + typeName
            + " is missing field '"
  ...
  static void warnMissingField(String typeName, String fieldName) {
    System.err.println(
        "[Config] " + typeName + " is missing field '" + fieldName + "'. Using default value.");
  }

  static void warnWrongFieldType(
