 ...
 * schema fields {@code type} and {@code value} are persisted. That avoids leaking runtime-only bean
 * properties such as {@code controller}, {@code rotation}, or {@code childEntries} that appear on
 * node getters.
 *
